...
{
    #[Test]
    public function it_always_includes_the_patient_documents_relation_manager(): void
    {
        $this->assertContains(PatientDocumentsRelationManager::class, PatientResource::getRelations());
    }
